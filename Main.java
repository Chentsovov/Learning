...
public class Main {
    public static void main(String[] args) {
        PrintName rectangle = new Rectangle("Rectangle");
        PrintName circle = new Circle("Circle");

        List<PrintName> toPrint = Arrays.asList(rectangle, circle);
        for (PrintName s : toPrint) {
            s.printName();
        }
    }
}
